	...
	calculate_total_amount: function(frm) {
		...
		frappe.call({
			...
			callback: function (r) {
				...
				if((frm.doc.discount) && (r.message.used == 0)){
					var dis_amount = frm.doc.discount/100 * grand_total;
					frm.set_value("amount_deduced", parseInt(dis_amount));
					frm.set_value("grand_total", grand_total - frm.doc.amount_deduced);
					frappe.call({
